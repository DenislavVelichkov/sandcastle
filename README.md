...
The workflow also supports [durable owner answers](docs/workflow.md#durable-human-answers) through an authenticated host route, with separate queued and applied receipts while independent tasks continue.
