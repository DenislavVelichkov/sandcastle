...
const owner = resolve(source, "../sandcastle-issue26-run-v5");
const consumer = resolve(source, "../sandcastle-issue26-release-v23/consumer");
...
const policyId = "issue26-seven-arm-v5";
...
assert.equal(release.sourceCommit, "c784396c038ed9a41f4634df4e926e21e71ac5da");
assert.equal(release.version, "0.12.0-dv8.23.0");
...
async function calibration() {
  ...
  const options = {
    ...
    usage: {
      ...
      pilot: { id: "issue26-v5", directory: pilot },
      readAccount,
      listModels,
    },
  };
